...
<head>
    ...
    <style>
        /* A simple fade-in animation for components */
        @keyframes fadeIn {
...
<body class="bg-slate-900">
    ...
    <script type="text/babel">
        ...
        // Explicitly destructuring hooks from the React object.
            ...
            if (!reportData.business_found) {
                return (
                    <div className="max-w-4xl mx-auto animate-fade-in">
                        ...
                        {/* Other sections for 'not found' case */}
                                ...
                                <div className="space-y-6 animate-fade-in">
                                    ...
                                    <div className="flex items-start">
                                     ...
                                     <div className="flex items-start">
                                        ...
                                        <label htmlFor="authorize" className="ml-2 text-slate-300">I authorize SEO Sentinel to manage my Google Business Profile.</label>
                                    </div>
                                </div>
                            )}
